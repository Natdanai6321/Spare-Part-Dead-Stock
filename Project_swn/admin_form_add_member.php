                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
<form  name="member" action="admin_form_add_member_db.php" method="POST" id="member" class="form-horizontal">
...
<br>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input name="m_nameF" type="text" required class="form-control" id="m_nameF"   placeholder="Firstname">
    </div>
  </div>
  <br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input name="m_nameL" type="text" required class="form-control" id="m_nameL"   placeholder="Lastname">
    </div>
  </div>
  <br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input name="m_userID" type="text" required class="form-control" id="m_userID"  placeholder="Personal ID">
    </div>
  </div>
  <br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input name="m_department" type="text" required class="form-control" id="m_department"   placeholder="Department">
    </div>
  </div>
  <br>
  <div class="form-group row">
    ...
    <div class="col-sm-10">
    <input name="m_tel" type="text" required class="form-control" id="m_tel"   placeholder="Tel">
    </div>
  </div>
